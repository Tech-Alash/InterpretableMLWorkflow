"""
This script determines the experimental parameters. For each parameter, one can set a single value or a list of parameter values. Doing the latter, the 
script experiment.py will iterate through all parameter combinations.
"""
