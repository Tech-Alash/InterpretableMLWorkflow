...
def load_experiment_parameters(filepath):
...
def prepare_raw_data():
    """Load the raw macroeconomic data and apply the initial cleaning steps."""
    ...
    return raw_data, transformations


def main():
    """Run the forecasting and out-of-bag experiment workflow."""
    ...
    experiment_parameters = load_experiment_parameters(exp_setup_filepath)
    experiment_parameters["output_folder"] = "results/test_case/"

    raw_data, transformations = prepare_raw_data()
